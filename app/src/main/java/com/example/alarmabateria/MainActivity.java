package com.example.alarmabateria;
...
public class MainActivity extends AppCompatActivity {
    ...
    private BroadcastReceiver mBatInfoReceiver = new BroadcastReceiver(){
        ...
        public void onReceive(Context ctxt, Intent intent) {
            ...
            pgBar.getProgressDrawable().setColorFilter( Color.YELLOW, android.graphics.PorterDuff.Mode.SRC_IN);
            ...
            if(usbCharge || acCharge){
                if(level == 100 && !ringtoneAlarm.isPlaying()){
                    ringtoneAlarm.play();
                    Toast.makeText(ctxt.getApplicationContext(),"Carga Completa",Toast.LENGTH_SHORT).show();
                ...
                if(ringtoneAlarm.isPlaying()){
                    ringtoneAlarm.stop();
                    Toast.makeText(ctxt.getApplicationContext(),"Desconectado",Toast.LENGTH_SHORT).show();
                }
            }
